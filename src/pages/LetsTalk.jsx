        ...
        <div className="grid gap-8 rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900 to-slate-950 p-6 shadow-2xl shadow-slate-900/40 lg:grid-cols-[1fr,1fr] lg:p-10">
          ...
          >
            ...
            <p className="text-slate-300">
              Use the scheduler to choose a time that works best. Once it&apos;s
              confirmed, you will receive a calendar invite with the video
              conference link automatically generated by the booking service.
            </p>
